...
if is_show_time_figure:
    ...
    y3 = [5.76, 5.81, 5.97, 6.83,    21.40]#(bitKRE, n=30)
    y4 = [3.88, 3.92, 4.02, 7.66, 46.56]#(batchKRE, \omega=3)
    ...
    y3 = [40365,43740,77490,414990, 1878325] #(bitKRE, n=30)
    y4 = [915,4290,38040,375540,3750540] #(batchKRE, \omega=3)
